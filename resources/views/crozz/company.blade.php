        ...
        <div class="row m-0">
            <div class="col">
                ...
                <table class="table table-hover" id="tblLocations">
                    ...
                    <thead>
                    <tr>
                        <td scope="col">Військова частина</td>
                    </tr>
                    </thead>
                    <tbody class="row_position">
                    @foreach($company as $companies)
                        <tr class="forms all_of_stage" data-bs-toggle="modal" data-bs-target="#modal-create" id="{{$companies['id']}}">


                            {{--Військова частина--}}
                            {{--company--}}
                            <td>@if($companies['company']!=null)
                                    {{$companies['company']}}
                                @else -
                                @endif
                            </td>
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        function updateOrder(data) {
            let urladd = "{{route('companysorted')}}";
            let _token = '{{ csrf_token() }}';
            $.ajax({
                url:urladd,
                type:'post',
